...
public:
    ...
    FinalScene(int width, int height, const wchar_t* title) :
        ...
        m_lights(std::make_unique<Quad>(Point3(123.f, 554.f, 147.f), Vector3(300.f, 0.f, 0.f), Vector3(0.f, 0.f, 265.f), m_emptyMaterial.get()))
    {
    }
...
protected:
    ...
    void InitWorld(World& world) override
    {
        ...
        world.AddObject<Quad>(Point3(123.f, 554.f, 147.f), Vector3(300.f, 0.f, 0.f), Vector3(0.f, 0.f, 265.f), m_light.get());
        ...
        std::shared_ptr<Sphere> boundary = std::make_shared<Sphere>(Point3(360.f, 150.f, 145.f), 70.f, m_glassMaterial.get());
