...
public:
    ...
    [[nodiscard]] const Point3& GetIntersection() const
    {
    ...
    void OffsetIntersection( const Vector3& offset )
    {
        m_intersection += offset;
    }
    ...
    void SetFaceNormal( const Vector3& faceNormal )
    {
        m_normal = faceNormal;
    }
    void SetFrontFace( bool isFrontFace )
    {
        m_frontFace = isFrontFace;
    }
};
